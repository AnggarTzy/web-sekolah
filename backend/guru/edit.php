...
<head>
    ...
    <title>Edit Guru | Admin SMP Muhammadiyah 6 Krian</title>
            ...
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Perbarui informasi guru.</p>
                    </div>
                </div>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" value="<?= htmlspecialchars($guru['nama']) ?>" required class="w-full pl-12 pr-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="jabatan" value="<?= htmlspecialchars($guru['jabatan']) ?>" class="w-full pl-12 pr-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="bidang_studi" value="<?= htmlspecialchars($guru['bidang_studi']) ?>" class="w-full pl-12 pr-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <?php endif; ?>
                        <label class="block text-sm font-semibold text-slate-700 mb-2 mt-4">Ganti Foto (jika ada)</label>
