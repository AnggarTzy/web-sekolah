...
<body class="bg-gray-50 font-sans text-slate-700 antialiased">
    ...
    <main class="max-w-7xl mx-auto p-6 sm:p-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                <h1 class="font-headline font-extrabold text-3xl text-primary">Kelola Guru</h1>
                <p class="text-gray-500 mt-1">Manajemen data tenaga pendidik.</p>
            </div>
            <a href="tambah.php" class="px-6 py-3 bg-primary text-white rounded-xl font-semibold text-sm hover:bg-opacity-90 transition shadow-lg">+ Tambah Guru</a>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left font-semibold text-gray-500">Foto</th>
                            <th class="px-6 py-4 text-left font-semibold text-gray-500">Nama</th>
                            <th class="px-6 py-4 text-left font-semibold text-gray-500">Jabatan</th>
                            <th class="px-6 py-4 text-left font-semibold text-gray-500">Bidang Studi</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <?php if ($row['foto']) : ?>
                                    <img src="../../uploads/<?= $row['foto'] ?>" class="w-12 h-12 object-cover rounded-full border border-gray-200">
                                <?php else : ?>
