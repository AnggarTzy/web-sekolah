...
<head>
    ...
    <title>Kelola Guru | Admin SMP Muhammadiyah 6 Krian</title>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h1 class="font-headline font-extrabold text-2xl sm:text-3xl text-primary">Kelola Guru</h1>
                        <p class="text-sm text-slate-500">Manajemen data tenaga pendidik.</p>
                    </div>
                </div>
            </div>
