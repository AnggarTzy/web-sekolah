...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "DELETE FROM prestasi WHERE id = ?");
    mysqli_stmt_bind_param($stmt, "i", $id);

    if (mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
        catat_aktivitas($conn, 'Prestasi', 'Menghapus', $prestasi['judul']);
...
<head>
    ...
    <title>Hapus Prestasi | Admin SMP Muhammadiyah 6 Krian</title>
        ...
        <section class="bg-red-50 border-b border-red-100">
            <div class="w-full px-5 sm:px-8 lg:px-12 py-10 sm:py-14">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h1 class="font-headline font-extrabold text-3xl sm:text-4xl text-primary mt-6">Hapus Prestasi?</h1>
        ...
        <section class="w-full px-5 sm:px-8 lg:px-12 py-8 sm:py-10">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                <div class="px-5 sm:px-7 py-5 border-b border-slate-100">
                    <h2 class="font-headline font-bold text-lg sm:text-xl text-slate-800">Prestasi yang akan dihapus</h2>
                    ...
                    <div class="flex flex-col md:flex-row gap-6 p-5 bg-slate-50 rounded-2xl border border-slate-200">
                        ...
                        <div class="w-full md:w-72 lg:w-80 flex-shrink-0">
                            <?php if (!empty($prestasi['gambar'])) : ?>
                                <img src="../../uploads/<?= htmlspecialchars($prestasi['gambar']) ?>"
                        ...
                        <div class="flex-1 min-w-0 flex flex-col justify-center">
                            ...
                            <div class="flex items-center gap-2 mt-5 text-sm text-slate-500">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-slate-700"><?= htmlspecialchars($prestasi['tingkat']) ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-2 mt-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-slate-700"><?= htmlspecialchars($prestasi['tahun']) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700 mt-1 leading-relaxed">
                            Prestasi ini akan dihapus secara permanen dari database beserta gambar yang tersimpan. Data yang sudah dihapus tidak dapat dikembalikan.
                        </p>
                    </div>
                </div>
            </div>
