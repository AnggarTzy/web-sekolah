...
<head>
    ...
    <title>Tambah Fasilitas | Admin SMP Muhammadiyah 6 Krian</title>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="font-headline font-extrabold text-2xl text-primary">Tambah Fasilitas</h1>
                        <p class="text-sm text-slate-500">Lengkapi informasi fasilitas di bawah ini.</p>
                    </div>
                </div>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" required class="w-full pl-12 pr-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" placeholder="Contoh: Laboratorium Komputer">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="5" class="w-full px-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition resize-y" placeholder="Tulis deskripsi fasilitas..."></textarea>
                    </div>
