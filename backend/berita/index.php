            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php if ($query && mysqli_num_rows($query) > 0): ?>
                            <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                                <tr class="hover:bg-slate-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if ($row['gambar']) : ?>
                                            <img src="../../uploads/<?= htmlspecialchars($row['gambar']) ?>" class="w-20 h-14 object-cover rounded-lg border border-slate-200" alt="Gambar">
                                        <?php else : ?>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="px-6 py-10 text-center text-slate-400">Belum ada berita</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
