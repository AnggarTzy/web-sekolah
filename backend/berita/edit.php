...
<main class="max-w-5xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="mb-7">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="font-headline font-extrabold text-2xl sm:text-3xl text-primary">Edit Berita</h1>
                <p class="text-sm text-slate-500">Perbarui informasi berita yang sudah ada.</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="deskripsi" value="<?= htmlspecialchars($berita['deskripsi'] ?? '') ?>"
                               class="w-full px-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition"
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <?php if (!empty($berita['gambar'])) : ?>
                    <div class="mb-6">
                        <p class="text-sm font-semibold text-slate-700 mb-3">Gambar Saat Ini</p>
                ...
                <?php else : ?>
                    <div class="mb-6 p-6 bg-slate-50 rounded-2xl border border-dashed border-slate-300 text-center">
                        ...
                        <p class="text-sm text-slate-500 mt-2">Berita ini belum memiliki gambar.</p>
                    </div>
                <?php endif; ?>

                <div>
                    <p class="text-sm font-semibold text-slate-700 mb-3">Ganti Gambar</p>
                    <label for="gambar"
